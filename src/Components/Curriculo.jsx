...
import {SiBlender, SiAdobephotoshop, SiAdobeaftereffects, SiAdobepremierepro} from 'react-icons/si'
    ...
    <div className="grid grid-cols-2 mt-32 w-full p-16 ml-40">
      <div className="flex-col">
        ...
        <ul className="leading-10">
          ...
          <li className="leading-6 mt-2">Técnico em informatica</li>
          <li className="leading-6 text-sm">
            E.T.E.S.P. - Escola Tecnica Estadual de São Paulo
          </li>
          <br></br>
          ...
          <li>___________________________________________________</li>
          <li className="text-lg leading-10 font-medium">Experiências profissionais</li>
      ...
      <div className="flex-col mt-12">
        <ul>
          ...
          <li className="text-lg leading-10 mt-2 font-medium">Habilidades desenvolvidas</li>
          <ul className="flex grid grid-cols-2 mt-2">
            <li className="flex items-center leading-6 mt-2 text-lg"><SiBlender className="mr-2"/> Blender</li>
            <li className="flex items-center leading-6 mt-2 text-lg"><GiMuscularTorso className="mr-2"/> Escultura</li>
            <li className="flex items-center leading-6 mt-2 text-lg"><SiAdobephotoshop className="mr-2"/> Photoshop</li>
            <li className="flex items-center leading-6 mt-2 text-lg" text-lg><GiPaintBrush className="mr-2"/> Pintura</li>
            <li className="flex items-center leading-6 mt-2 text-lg"><SiAdobeaftereffects className="mr-2"/> After Effects</li>
            <li className="flex items-center leading-6 mt-2 text-lg"><GiPhotoCamera className="mr-2"/> Fotografia</li>
            <li className="flex items-center leading-6 mt-2 text-lg"><SiAdobepremierepro className="mr-2"/> Premiere</li>
            <li> </li>
            <li className="flex items-center leading-6 mt-2 text-lg"><FaAsterisk className="mr-2"/> P5.js</li>
          </ul>
